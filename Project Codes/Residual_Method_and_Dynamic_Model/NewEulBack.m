    function tau = NewEulBack(N,m,I,mm,Im,kri,q,qd,qdd,fv,fc,W,Wd,Wmd,Pcdd,Rij,Rici,Rot)
...
for i = (N:-1:1)
    ...
    curr_u = cross(-curr_f,rij+rici) + R*prev_u + cross(R*prev_f,rici) ...
             ...
             + kri*qdd(i+1)*(Im_tensor*zm) + kri*qd(i+1)*(cross(Im_tensor*w,zm));   
